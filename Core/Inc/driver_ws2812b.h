...
// Based on 80 MHz peripheral clock at 1-1 pre-scaler and 100-1 ARR with time period of 1.25 us.
...
#define WS2812B_DMA_BUF_LEN ((LED_COUNT * WS2812B_BITS_PER_LED) + WS2812B_RST_VAL_PERIODS)
